...
class Keithley2700StreamInterface(StreamInterface):
    ...
    commands = {
        ...
        CmdBuilder("get_multicmds", arg_sep="", ignore_case=True).get_multicommands(";").build(),
        ...
        CmdBuilder("set_measurement", ignore_case=True)
        .escape(":FUNC ")
        .regex("(?:'|\")")
        ...
        CmdBuilder("set_buffer_feed", ignore_case=True)
        .escape("TRAC:FEED ")
        .arg("SENS|CALC|NONE")
        .eos()
        .build(),
        CmdBuilder("set_buffer_control", ignore_case=True)
        .escape("TRAC:FEED:CONT ")
        .arg("NEV|NEXT|ALW")
        .eos()
        .build(),
        CmdBuilder("set_buffer_state", ignore_case=True)
        .escape("TRAC:CLE:AUTO ")
        .arg("OFF|ON")
        .eos()
        .build(),
        ...
        CmdBuilder("get_readings", arg_sep="", ignore_case=True)
        .escape("TRAC:DATA:SEL? ")
        .int()
        .escape(",")
        .int()
        .eos()
        ...
        CmdBuilder("set_time_stamp_format", ignore_case=True)
        .escape("TRAC:TST:FORM ")
        .arg("ABS|DELT")
        .eos()
        .build(),
        CmdBuilder("get_time_stamp_format", ignore_case=True)
        .escape("TRAC:TST:FORM?")
        .eos()
        .build(),
        CmdBuilder("get_delay_state", ignore_case=True).escape("TRIG:DEL:AUTO?").eos().build(),
        CmdBuilder("set_delay_state", ignore_case=True)
        .escape("TRIG:DEL:AUTO ")
        .arg("OFF|ON")
        .eos()
        .build(),
        CmdBuilder("set_init_state", ignore_case=True)
        .escape("INIT:CONT ")
        .arg("OFF|ON")
        .eos()
        .build(),
        ...
        CmdBuilder("set_source", ignore_case=True)
        .escape("TRIG:SOUR ")
        .arg("IMM|TIM|MAN|BUS|EXT")
        .eos()
        .build(),
        CmdBuilder("set_data_elements", ignore_case=True)
        .escape("FORM:ELEM READ,")
        .spaces(at_least_one=False)
        .escape("CHAN,")
        .spaces(at_least_one=False)
        .escape("TST")
        ...
        .eos()
        .build(),
        CmdBuilder("set_auto_range_status", arg_sep="", ignore_case=True)
        .optional(":")
        .escape("FRES:RANG:AUTO ")
        .arg("OFF|ON")
        .spaces(at_least_one=False)
        .optional(",")
        .spaces(at_least_one=False)
        ...
        .eos()
        .build(),
        CmdBuilder("get_auto_range_status", ignore_case=True)
        .optional(":")
        .escape("FRES:RANG:AUTO?")
        .eos()
        .build(),
        CmdBuilder("set_resistance_digits", arg_sep="", ignore_case=True)
        .optional(";")
        .escape(":FRES:DIG ")
        .int()
        .spaces(at_least_one=False)
        ...
        .eos()
        .build(),
        CmdBuilder("set_resistance_rate", ignore_case=True)
        .optional(";")
        .escape(":FRES:NPLC ")
        .float()
        .optional("E+0")
        .eos()
        .build(),
        CmdBuilder("set_scan_state", ignore_case=True)
        .escape("ROUT:SCAN:LSEL ")
        .arg("INT|NONE")
        .eos()
        .build(),
        CmdBuilder("get_scan_state", ignore_case=True).escape("ROUT:SCAN:LSEL?").eos().build(),
        CmdBuilder("set_scan_channels", arg_sep="", ignore_case=True)
        .escape("ROUT:SCAN (@")
        .int()
        .escape(":")
        .int()
    ...
    def get_readings(self, start, count):
        ...
        self.log.info(
            "Returned readings: {}".format(
                "No readings" if (len(chunks) == 0) else ",".join(chunks)
            )
        )
        return ", ".join(chunks)
    ...
    def get_scan_channels(self):
        return "(@{}:110,201:{})".format(
            self._device.scan_channel_start, self._device.scan_channel_end
        )
